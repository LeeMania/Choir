 ...
 */
package dk.cphbusiness.choir.ws;
 ...
 * for
 * REST
 * resource:PersonsFacadeREST
 * [wannabekrak.persons]<br>
 * USAGE:
 * <pre>
...
public class KrakClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/WannaBeCrack/webresources";

    public KrakClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("wannabekrak.persons");
    }

    public <T> T findPhone_XML(Class<T> responseType, String phone) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("phone/{0}", new Object[]{phone}));
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findPhone_JSON(Class<T> responseType, String phone) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("phone/{0}", new Object[]{phone}));
